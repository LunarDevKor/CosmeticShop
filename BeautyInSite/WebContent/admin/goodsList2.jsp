	...
	<div id="wrapper">
		...
		<div id="snb">
			...
			<dl>
				...
				<dd class="o10">
					<a href="<%=request.getContextPath()%>/admin/orderlist.do">주문리스트(전체)<em
						class="snb_air">27</em></a>
				</dd>
				<dd class="o10">
				...
				<dt class="o30 menu_toggle">기타관리</dt>
			</dl>
		</div>
		<div id="content">
			...
			<div class="s_wrap">
				...
				<form name="fgoodslist" id="fgoodslist" method="post"
					...
					<div class="local_ov mart30">
						전체 : <b class="fc_red">13</b> 건 조회 <span class="ov_a"> <!-- <select
							id="page_rows"
					...
					<div class="local_frm01">
						...
						<a href="prodWrite.do" class="fr btn_lsmall red"><i
...
// 		alert( $(this).text() );
		location.href="prodSearchaAdmin.do?cate=<%=cate%>&search=<%=search%>&page=" + $(this).text();
	});
	...
	$('.next').on('click',function(){
		...
		location.href=location.href="prodSearchaAdmin.do?cate=<%=cate%>&search=<%=search%>&page=" + currentPage;
	});
	...
	$('.prev').on('click',function(){
		...
		location.href="?cate=<%=cate%>&search=<%=search%>&page="+ currentPage;
	});
					</script>
