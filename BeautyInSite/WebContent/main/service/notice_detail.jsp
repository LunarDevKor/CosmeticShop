...
<aside id="aside">
	...
	<dl class="aside_cs">	
		<dt><a href="notice.do">공지사항</a></dt>
		<dt><a href="qnaList.do">1:1 상담문의</a></dt>		
		<dt><a href="faq.do">자주묻는질문</a></dt>		
	</dl>
</aside>
<!-- } 좌측메뉴 끝 -->
...
<form name="fboardform" id="fboardform" method="post" action="write.do" onsubmit="return fboardform_submit(this);" autocomplete="off" enctype="MULTIPART/FORM-DATA">
...
%>
    ...
    %>
        <a href="noticeUpdate.do?noticeNo=<%=noticeVO.getNoticeNo() %>" class="btn_lsmall bx-white">수정</a>
			<a href="noticeDelete.do?noticeNo=<%=noticeVO.getNoticeNo() %>" class="btn_lsmall bx-white">삭제</a>
    <%
        }
    %>
