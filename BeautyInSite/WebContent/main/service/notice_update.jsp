...
<form name="fboardform" id="fboardform" method="post" action="noticeUpdate.do" onsubmit="return fboardform_submit(this);" autocomplete="off" enctype="MULTIPART/FORM-DATA">
